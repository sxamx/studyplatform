...
export const CreatorGuidesPage: React.FC = () => {
  ...
  const promptTemplates = [
    {
      id: 'p-full-course',
      title: 'Generar Curso Completo en Carpeta Modular',
      prompt: `Actúa como Diseñador Instruccional Senior. Diseña un curso completo sobre [TEMA AQUÍ] dividido en 3 módulos pedagógicos. Para cada módulo genera 2 lecciones interactivas. Cada lección debe incluir: 1 bloque heading, 1 bloque text explicativo, 1 bloque code práctico, 1 bloque diagram (Mermaid) y 1 quiz de 2 preguntas.`,
    },
    {
      id: 'p-mermaid',
      title: 'Crear Diagrama Mermaid Técnico',
      prompt: `Crea un bloque de tipo 'diagram' con sintaxis Mermaid.js que ilustre claramente el flujo de ejecución de [ALGORITMO O ARQUITECTURA]. Asegúrate de usar nodos con nombres descriptivos y relaciones visuales lógicas.`,
    },
    {
      id: 'p-quiz',
      title: 'Diseñar Evaluación / Quiz de Refuerzo',
      prompt: `Genera un bloque de tipo 'quiz' con 3 preguntas de opción múltiple desafiantes sobre [CONCEPTO]. Cada pregunta debe incluir retroalimentación pedagógica detallada explicando por qué la opción correcta es válida y por qué las demás no.`,
    },
  ];
        ...
        <div className="space-y-4">
          {promptTemplates.map((template) => (
            <Card key={template.id} className="p-5">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-300 p-3 bg-gray-50 dark:bg-[#1A1A1A] rounded-xl border border-[#E0E0E0] dark:border-[#2D2D2D] leading-relaxed">
                {template.prompt}
              </p>
            </Card>
          ))}
